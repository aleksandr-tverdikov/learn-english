# Core vocabulary: communication and the internet

> The everyday nouns of communication and the internet — pronunciation, Russian, plural, and three examples each.
...
**Pronunciation:** /ˈwaɪfaɪ/ &middot; *WY-fy*
**Русский:** вайфай, беспроводной интернет
**Countability:** uncountable

A wireless connection that lets devices reach the internet.

1. Does the hotel have free *wifi*?
2. The *wifi* keeps cutting out in the back bedroom.
3. I gave my neighbor the *wifi* password.
...
**Pronunciation:** /ˈhoʊmpeɪdʒ/ &middot; *HOHM-payj*
**Русский:** главная страница (сайта)
**Plural:** *homepages*
**Countability:** countable

The first page you see when you open a website.

1. The sale is right there on the *homepage*.
2. They redesigned the *homepage* last spring.
3. Most *homepages* load in under two seconds.

---

### hacking

**Pronunciation:** /ˈhækɪŋ/ &middot; *HAK-ing*
**Русский:** взлом (компьютерный)
**Countability:** uncountable

The act of breaking into computer systems without permission.

1. He got two years in prison for *hacking*.
2. The report blames *hacking* for the outage.
3. *Hacking* into a school's grade system is still a crime.
...
**Pronunciation:** /ˈroʊmɪŋ/ &middot; *ROH-ming*
**Русский:** роуминг
**Countability:** uncountable

The use of a phone on another company's network, usually in another country.

1. Turn off *roaming* before you land.
2. *Roaming* charges cost her two hundred dollars.
3. The plan includes *roaming* in Canada and Mexico.

---

### sender

**Pronunciation:** /ˈsɛndər/ &middot; *SEN-dur*
**Русский:** отправитель
**Plural:** *senders*
**Countability:** countable

The person or address that a message comes from.

1. Always check the *sender* before you open an attachment.
2. The *sender* used a fake company name.
3. You can block *senders* you don't recognize.

---

### recipient

**Pronunciation:** /rɪˈsɪpiənt/ &middot; *rih-SIP-ee-unt*
**Русский:** получатель, адресат
**Plural:** *recipients*
**Countability:** countable

The person a message or package is sent to.

1. Add the *recipient* before you hit send.
2. The email went out to two thousand *recipients*.
3. The *recipient* never picked up the package.
...
An answer sent back to a message or comment.

1. I sent it Monday and still haven't gotten a *reply*.
2. His *replies* are always one word long.
3. Send a quick *reply* so she knows you saw it.

---

### messenger

**Pronunciation:** /ˈmɛsəndʒər/ &middot; *MES-un-jur*
**Русский:** мессенджер; посыльный
**Plural:** *messengers*
**Countability:** countable

An app for sending messages, or a person who carries messages.

1. Send me the address on *messenger*.
2. A bike *messenger* dropped off the contract.
3. She uses two different *messengers* for work and family.
...
**Pronunciation:** /ˈtʃætbɑːt/ &middot; *CHAT-baht*
**Русский:** чат-бот
**Plural:** *chatbots*
**Countability:** countable

A program that holds a typed conversation with a person.

1. The *chatbot* couldn't answer my question.
2. Most airlines make you fight a *chatbot* first.
3. They replaced two support agents with *chatbots*.

---

### paywall

**Pronunciation:** /ˈpeɪwɔːl/ &middot; *PAY-wawl*
**Русский:** платный доступ, пейволл
**Plural:** *paywalls*
**Countability:** countable

A block on a website that makes you pay before you can read more.

1. The article is behind a *paywall*.
2. Most big papers put up a *paywall* years ago.
3. Some *paywalls* let you read three stories a month.

---

### clickbait

**Pronunciation:** /ˈklɪkbeɪt/ &middot; *KLIK-bayt*
**Русский:** кликбейт (завлекающие заголовки)
**Countability:** uncountable

Headlines written to make people click, not to tell them anything.

1. That headline is pure *clickbait*.
2. The site runs on *clickbait* and ads.
3. I stopped reading anything that looks like *clickbait*.

---

### livestream

**Pronunciation:** /ˈlaɪvstriːm/ &middot; *LYVE-streem*
**Русский:** прямая трансляция
**Plural:** *livestreams*
**Countability:** countable

A video broadcast over the internet as it happens.

1. The church puts a *livestream* up every Sunday.
2. Her *livestream* had four thousand people watching.
3. They ran two *livestreams* at the same time.
...
**Pronunciation:** /ˈmɛɡəbaɪt/ &middot; *MEG-uh-byte*
**Русский:** мегабайт
**Plural:** *megabytes*
**Countability:** countable

A unit of computer storage equal to about a million bytes.

1. The email bounced because the file was over ten *megabytes*.
2. A photo is usually a few *megabytes*.
3. One *megabyte* used to feel like a lot.

---

### telephone

**Pronunciation:** /ˈtɛləfoʊn/ &middot; *TEL-uh-fohn*
**Русский:** телефон
**Plural:** *telephones*
**Countability:** countable

A device for speaking to someone far away over a line or network.

1. There's a *telephone* on the wall by the register.
2. The old *telephones* in the building still work.
3. He wrote down the *telephone* number on a napkin.
...
**Pronunciation:** /dəˈrɛktəri/ &middot; *duh-REK-tuh-ree*
**Русский:** справочник; каталог (папок)
**Plural:** *directories*
**Countability:** countable

A list of names, numbers, or files arranged in order.

1. Her number isn't in the *directory*.
2. The building *directory* is next to the elevator.
3. The files are in two different *directories*.
...
A copy of a document sent over a phone line, or the machine that sends it.

1. The clinic still wants the form by *fax*.
2. Two *faxes* came in overnight.
3. Nobody in the office knows how to work the *fax*.

---

### announcement

**Pronunciation:** /əˈnaʊnsmənt/ &middot; *uh-NOWNS-munt*
**Русский:** объявление, сообщение
**Plural:** *announcements*
**Countability:** countable

A public statement telling people something has happened or will happen.

1. They made the *announcement* over the intercom.
2. The morning *announcements* take five minutes.
3. We're expecting an *announcement* from the mayor today.
...
**Pronunciation:** /ˌkɑːnvərˈseɪʃən/ &middot; *kahn-vur-SAY-shun*
**Русский:** разговор, беседа
**Plural:** *conversations*
**Countability:** countable

A talk between two or more people.

1. We had a long *conversation* about the move.
2. I overheard two *conversations* about layoffs.
3. That's a *conversation* for another day.

---

### response

**Pronunciation:** /rɪˈspɑːns/ &middot; *rih-SPAHNS*
**Русский:** ответ, отклик
**Plural:** *responses*
**Countability:** countable

Something said, written, or done as an answer or reaction.

1. Her *response* came within the hour.
2. We got over five hundred *responses* to the survey.
3. There's been no *response* from the company.
...
**Pronunciation:** /tuːˈtɔːriəl/ &middot; *too-TOR-ee-ul*
**Русский:** обучающее руководство, туториал
**Plural:** *tutorials*
**Countability:** countable

A lesson or guide that shows you step by step how to do something.

1. I fixed the sink by watching a *tutorial*.
2. The app opens with a short *tutorial*.
3. There are hundreds of *tutorials* for that program.
