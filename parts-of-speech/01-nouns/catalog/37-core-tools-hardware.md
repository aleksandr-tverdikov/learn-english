# Core vocabulary: tools and hardware

> The everyday nouns of tools and hardware — pronunciation, Russian, plural, and three examples each.
...
**Pronunciation:** /ˈtuːlbɑːks/ &middot; *TOOL-bahks*
**Русский:** ящик для инструментов
**Plural:** *toolboxes*
**Countability:** countable

A box with a handle for carrying and storing tools.

1. His *toolbox* weighs a ton.
2. There's a flashlight in the bottom of the *toolbox*.
3. Both *toolboxes* were sitting open on the tailgate.

---

### kit

**Pronunciation:** /kɪt/ &middot; *KIT*
**Русский:** набор, комплект
**Plural:** *kits*
**Countability:** countable

A set of tools or parts packaged together for one purpose.

1. I keep a small repair *kit* under the seat.
2. The shelf came as a *kit* with all the screws included.
3. They sell first-aid *kits* right by the register.
...
**Pronunciation:** /ˈhæksɔː/ &middot; *HAK-saw*
**Русский:** ножовка по металлу
**Plural:** *hacksaws*
**Countability:** countable

A saw with a fine blade held in a frame, used for cutting metal.

1. A *hacksaw* will go right through that bolt.
2. I broke two blades on the *hacksaw*.
3. Both *hacksaws* need new blades.

---

### chainsaw

**Pronunciation:** /ˈtʃeɪnsɔː/ &middot; *CHAYN-saw*
**Русский:** бензопила, цепная пила
**Plural:** *chainsaws*
**Countability:** countable

A power saw whose teeth run around a moving chain.

1. He cleared the fallen tree with a *chainsaw*.
2. Don't start the *chainsaw* without safety glasses.
3. After the storm you could hear *chainsaws* all over the neighborhood.
...
**Pronunciation:** /ˈdrɪl bɪt/ &middot; *DRIL-bit*
**Русский:** сверло
**Plural:** *drill bits*
**Countability:** countable

The removable cutting piece that a drill turns to make a hole.

1. You need a smaller *drill bit* for that screw.
2. The *drill bit* snapped off inside the wall.
3. I bought a set of *drill bits* on sale.
...
**Pronunciation:** /ˈtʃɪzəl/ &middot; *CHIZ-ul*
**Русский:** стамеска, зубило
**Plural:** *chisels*
**Countability:** countable

A tool with a flat sharpened end, struck to cut wood or stone.

1. He shaped the joint with a *chisel* and a hammer.
2. Keep the *chisel* sharp or it will tear the wood.
3. A set of wood *chisels* makes a good gift.
...
A large heavy hammer swung with both hands.

1. It took a *sledgehammer* to break up the old steps.
2. Don't swing that *sledgehammer* near the window.
3. The rental yard had *sledgehammers* by the door.

---

### crowbar

**Pronunciation:** /ˈkroʊbɑːr/ &middot; *KROH-bar*
**Русский:** лом, монтировка
**Plural:** *crowbars*
**Countability:** countable

A heavy iron bar with a flattened end, used to pry things apart.

1. Use a *crowbar* to pull those old boards off.
2. He pried the lid open with a *crowbar*.
3. There were two *crowbars* in the back of the truck.
...
**Русский:** струбцина, зажим
**Plural:** *clamps*
**Countability:** countable

A device that squeezes two things together and holds them.

1. Put a *clamp* on the joint while the glue dries.
2. The *clamp* left a mark in the wood.
3. I need two more *clamps* for this.
...
**Plural:** *vises*
**Countability:** countable
**Contrast:** Americans spell it vise, the British vice. Either way it sounds like vice.

A heavy clamp fixed to a bench that grips a workpiece.

1. He held the pipe in a *vise* while he cut it.
2. Every workbench should have a *vise* bolted to it.
3. The shop had *vises* on all four benches.
...
A metal pin hammered flat at both ends to join two pieces permanently.

1. A *rivet* holds the handle to the blade.
2. One *rivet* popped and the bracket came loose.
3. The old bridge is held together with *rivets*.

---

### stapler

**Pronunciation:** /ˈsteɪplər/ &middot; *STAY-plur*
**Русский:** степлер
**Plural:** *staplers*
**Countability:** countable
...
**Русский:** навесной замок
**Plural:** *padlocks*
**Countability:** countable

A detachable lock with a U-shaped bar that passes through a hasp or chain.

1. There's a *padlock* on the gate.
2. I cut the *padlock* off with a hacksaw.
3. Both *padlocks* use the same combination.

---

### rope

**Pronunciation:** /roʊp/ &middot; *ROHP*
**Русский:** верёвка, канат
**Plural:** *ropes*
**Countability:** countable, and uncountable as a substance

Thick cord made by twisting fibers together.

1. Tie the ladder down with a *rope*.
2. The *rope* frayed where it rubbed the edge.
3. They sell *rope* by the foot.
...
**Countability:** countable
**Contrast:** American extension cord; the British say extension lead.

A length of flexible cord that carries power farther from an outlet.

1. Run an *extension cord* out to the driveway.
2. That *extension cord* isn't rated for outdoor use.
3. We needed two *extension cords* to reach the shed.
...
**Pronunciation:** /hoʊz/ &middot; *HOHZ*
**Русский:** шланг
**Plural:** *hoses*
**Countability:** countable, and uncountable as a substance
...
**Pronunciation:** /ˈnɑːzəl/ &middot; *NAH-zul*
**Русский:** насадка, сопло
**Plural:** *nozzles*
**Countability:** countable

The narrow end fitted to a hose or sprayer to shape the stream.

1. Put the *nozzle* on the end of the hose.
2. The *nozzle* was clogged with dried paint.
3. The sprayer came with three *nozzles*.
...
**Pronunciation:** /ˈdʌkt teɪp/ &middot; *DUKT-tayp*
**Русский:** армированный скотч
**Countability:** uncountable

Strong cloth-backed sticky tape used for quick repairs.

1. He fixed the mirror with *duct tape*.
2. There's a roll of *duct tape* in the truck.
3. He wrapped the handle in *duct tape*.

---

### adhesive

**Pronunciation:** /ədˈhiːsɪv/ &middot; *ud-HEE-siv*
**Русский:** клей, клеящий состав
**Plural:** *adhesives*
**Countability:** countable, and uncountable as a substance

A substance made to bond materials together.

1. This *adhesive* works on metal and plastic.
2. Spread the *adhesive* evenly before you set the tile.
3. They carry industrial *adhesives* in the back.
...
A clear coating brushed on wood to give it a hard shiny surface.

1. Put a coat of *varnish* on the tabletop.
2. The *varnish* yellowed over the years.
3. Marine *varnishes* hold up better outdoors.

---

### putty

**Pronunciation:** /ˈpʌti/ &middot; *PUT-ee*
**Русский:** шпаклёвка, замазка
**Countability:** uncountable

A soft paste that hardens, used to fill holes and set glass.

1. Fill the nail holes with *putty*.
2. The *putty* has to dry before you sand it.
3. He smoothed the *putty* with his thumb.
...
**Русский:** герметик
**Countability:** uncountable
**Contrast:** The l is silent — caulk rhymes with talk.

A flexible filler squeezed into seams to keep water and air out.

1. Run a bead of *caulk* along the tub.
2. The old *caulk* was black with mildew.
3. Let the *caulk* cure overnight.
...
**Русский:** припой
**Countability:** uncountable
**Contrast:** Americans drop the l: SAH-dur, not SOL-dur.

A soft metal melted to join two pieces of metal or wire.

1. Heat the joint before you apply the *solder*.
2. The *solder* didn't flow into the seam.
3. Use lead-free *solder* on water lines.
...
**Pronunciation:** /ˈsændpeɪpər/ &middot; *SAND-pay-pur*
**Русский:** наждачная бумага
**Countability:** uncountable

Stiff paper coated with grit, rubbed on a surface to smooth it.

1. Smooth the edge with fine *sandpaper*.
2. I'm out of *sandpaper*.
3. Wrap the *sandpaper* around a block of wood.

---

### sander

**Pronunciation:** /ˈsændər/ &middot; *SAN-dur*
**Русский:** шлифовальная машинка
**Plural:** *sanders*
**Countability:** countable

A power tool that smooths a surface with moving sandpaper.

1. The belt *sander* took the finish off fast.
2. Wear a mask when you run the *sander*.
3. Both *sanders* need new pads.
...
A machine that burns fuel to make electricity.

1. We ran the fridge off a *generator* for three days.
2. The *generator* is loud but reliable.
3. Portable *generators* sold out before the storm.

---

### motor

**Pronunciation:** /ˈmoʊtər/ &middot; *MOH-tur*
**Русский:** мотор, электродвигатель
**Plural:** *motors*
**Countability:** countable

A machine that turns electricity or fuel into movement.

1. The *motor* on the fan is burned out.
2. You can hear the *motor* struggling.
3. Small electric *motors* are cheap to replace.
...
A sturdy table where tools are used and things are built.

1. He built a *workbench* out of scrap lumber.
2. Clear the *workbench* before you start.
3. Both *workbenches* have a vise on the end.
...
A folding ladder with flat steps that stands on its own.

1. Grab the *stepladder* from the garage.
2. Don't stand on the top step of a *stepladder*.
3. Both *stepladders* are aluminum.
...
**Pronunciation:** /ˈʃʌvəl/ &middot; *SHUV-ul*
**Русский:** лопата
**Plural:** *shovels*
**Countability:** countable

A tool with a broad blade and a long handle for digging and lifting.

1. Grab a *shovel* and start digging.
2. The *shovel* handle snapped.
3. Both *shovels* are in the truck bed.
...
**Pronunciation:** /ˈwiːlbæroʊ/ &middot; *WEEL-ba-roh*
**Русский:** тачка
**Plural:** *wheelbarrows*
**Countability:** countable

A small open cart with one wheel and two handles for moving loads.

1. Load the dirt into the *wheelbarrow*.
2. The *wheelbarrow* has a flat tire.
3. They had two *wheelbarrows* going all afternoon.
...
A flexible marked strip that rolls into a case, used to measure length.

1. Where's the *tape measure*?
2. The *tape measure* snapped back and got my finger.
3. I own four *tape measures* and can never find one.
...
**Pronunciation:** /leɪð/ &middot; *LAYTH*
**Русский:** токарный станок
**Plural:** *lathes*
**Countability:** countable
**Contrast:** The th is voiced — lathe rhymes with bathe, not with path.

A machine that spins a piece of wood or metal while a tool shapes it.

1. He turned the table leg on a *lathe*.
2. The *lathe* in the shop is older than I am.
3. Metal *lathes* take up a lot of floor space.
...
**Pronunciation:** /ˈpʊli/ &middot; *PUUL-ee*
**Русский:** блок, шкив
**Plural:** *pulleys*
**Countability:** countable
**Contrast:** The first syllable sounds like pull: PUUL-ee, not PYOO-lee.

A grooved wheel that a rope or belt runs over to lift or drive something.

1. A *pulley* makes the load feel half as heavy.
2. The rope came off the *pulley*.
3. The system runs on two *pulleys* and a cable.
...
**Plural:** *levers*
**Countability:** countable
**Contrast:** Americans usually say LEV-ur; the British say LEE-vur.

A bar that turns on a fixed point to move a heavy load with less force.

1. Use a long bar as a *lever* and it'll move.
2. The *lever* on the side releases the blade.
3. There are two *levers* under the seat.
...
**Русский:** пиломатериалы, доски
**Countability:** uncountable
**Contrast:** American lumber; the British say timber. Uncountable — never 'a lumber' or 'lumbers'.

Wood that has been sawn into boards for building.

1. The *lumber* is stacked behind the shed.
2. The price of *lumber* went up again.
3. We need enough *lumber* for a twelve-foot deck.

---

### plywood

**Pronunciation:** /ˈplaɪwʊd/ &middot; *PLY-wuud*
**Русский:** фанера
**Countability:** uncountable

Board made of thin layers of wood glued together.

1. Cover the window with a sheet of *plywood*.
2. The floor is just *plywood* for now.
3. Half-inch *plywood* should be strong enough.
...
A gray powder that hardens when mixed with water, used to bind concrete.

1. Mix the *cement* with sand and water.
2. A bag of *cement* weighs about ninety pounds.
3. The *cement* set faster than we expected.
...
**Pronunciation:** /ˈbɑːks kʌtər/ &middot; *BAHKS-kut-ur*
**Русский:** канцелярский нож
**Plural:** *box cutters*
**Countability:** countable

A knife with a short sliding blade, used to open cartons.

1. Open the carton with a *box cutter*.
2. The blade on the *box cutter* is dull.
3. They handed out *box cutters* on the loading dock.
