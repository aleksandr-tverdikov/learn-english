...
To give something a shape, or to come into existence as a shape.
...
To make a part or structure out of raw material, usually metal.
...
To press a soft material into a shape.
...
To make a small or virtual version of something in order to study it.
...
To describe the main parts of a plan without the details.
...
To put equipment in place so that it is ready to use.
...
To fasten something with bolts.
...
To stick or cover something with tape.
...
To make a round hole with a drill.
...
To hit something with a hammer, or to shape it by hitting.
...
To cover a wall or ceiling with a smooth layer of plaster.
...
To put electrical wiring into a building or a device.
...
To build the supporting structure of something, or to put it in a frame.
...
To cover a surface with paint, or to make a picture with paint.
...
To rub a surface until it shines.
...
To close a gap or cover a surface so that nothing gets through.
...
To cover something so that heat, cold, or electricity cannot pass through.
...
To shape hot metal by hammering it.
...
To pull something so that it becomes longer or tighter.
...
To press something so hard that it breaks into pieces or loses its shape.
...
To make a blade or a point sharp.
...
To cut a small amount off something to make it neat or to make it fit.
...
To join two things so that something can pass between them.
...
To put two pieces together so that they become one.
...
To fix something onto a wall, a stand, or a support.
...
To fix something firmly so that it cannot move.
...
To fasten something so that it stays in place.
...
To make something stronger by adding material or support.
...
To make something work again after it has broken.
...
To bring something old back to its original condition.
...
To change part of something so that it works differently.
...
To move or change something a little so that it is right.
...
To produce words or images on paper with a machine.
...
To make beer, or to make coffee or tea with hot water.
...
To move a liquid or mixture around with a stick or spoon.
...
To put a name or a mark on something so it can be identified.
...
To draw a line or sign on something to show where to cut or drill.
...
To put two or more things in a straight line, or in the right position.
...
To make a surface flat and horizontal.
...
To make something look better by adding color or ornament.
...
To make something exactly like an original.
...
To make a whole by putting parts together, especially music or writing.
...
To become hard, or to make something hard.
