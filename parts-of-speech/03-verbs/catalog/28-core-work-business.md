...
To do a job, especially one you are paid for.
...
To teach someone the skills a job needs.
...
To be in charge of a business, a team, or a difficult situation.
...
To make someone leave their job, usually for poor work or bad behavior.
...
To put a new person or thing in the place of another.
...
To plan and arrange something, or to put things in order.
...
To make the plans that are needed for something to happen.
...
To make different people or parts of a job work together smoothly.
...
To run a business or a machine, or to be active and working.
...
To be the person or organization that holds an event and receives the guests.
...
To arrange in advance to have a room, a seat, or a service.
...
To show or explain something formally to a group of people.
...
To settle an argument by each side giving up part of what it wants.
...
To end an argument or a debt by agreement.
...
To make an agreement, a license, or a subscription valid for another period.
...
To act or to speak officially for a person, a group, or a company.
...
To create something over time, or to grow and become more advanced.
...
To make or grow something, especially in large amounts.
...
To make goods in a factory, usually in large quantities.
...
To send someone a statement of how much they owe.
...
To start an organization or a system that is meant to last.
...
To make something smaller in size, amount, or price.
...
To not succeed, or to not do something that you should have done.
...
To work for a person, an organization, or a group of customers.
...
To deal with documents, data, or materials in an official or standard way.
...
To send an official document to an authority, or to store papers in order.
...
To give things out to a number of people, or to supply goods to stores.
