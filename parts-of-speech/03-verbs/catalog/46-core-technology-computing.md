...
To make a file, app, or window appear on a screen so you can use it.
...
To make a file, window, or program stop being open.
...
To shrink a window down to the taskbar without closing it.
...
To load a page or a file again.
...
To pull files or data out of an archive or a larger set.
...
To list and organize data so that it can be searched quickly.
...
To ask a database or a system for particular information.
...
To store data for a short time so that it loads faster the next time.
...
To put a video, a map, or a piece of code inside a page or a document.
...
To join a device or a call back to a network after it was cut off.
...
To fill a battery with power again.
...
To start a computer so that the operating system loads.
...
To start a computer or device again after shutting it down.
...
To respond slowly, so that the picture or the sound falls behind.
...
To send data or a signal from one place to another.
...
To show the picture from one screen on another, or to keep an identical copy of data.
...
To connect a computer to the internet through a phone's data connection.
...
To move to a lower, cheaper, or older version of software or a plan.
...
To use a computer to copy the way something works in real life.
...
To make one system behave exactly like another.
...
To change something in size, or to grow so as to handle much more work.
...
To check that data or a document is correct and acceptable.
...
To stop something from being used or changed without a key, a code, or a password.
...
To turn a setting or a feature on.
...
To turn a setting or a feature off.
...
To move from page to page on the internet with no fixed goal.
...
To ask a user on screen to do something, or to give a system an instruction.
...
To make a disk or a drive come out safely.
...
To put songs, cards, or files into a random order.
...
To connect computers or devices so that they can share data.
