# Core verbs: driving and transport

> The everyday regular verbs of driving and transport — all four forms, pronunciation, Russian, and three examples that use more than one form.
...
To keep moving without power, using only momentum or the slope.

1. Take your foot off the gas and *coast* to the sign.
2. The truck *coasted* the last half mile on empty.
3. We were *coasting* downhill with the engine off.
...
To make an engine turn faster and louder.
...
To move more slowly, or to make something move more slowly.

1. Rain will *slow* the whole delivery route.
...
To take a different route because the usual one is closed.

1. We can *detour* around the closed bridge.
2. The truck *detoured* through two small towns.
3. Traffic has been *detoured* onto a county road.
...
To put more fuel into a vehicle.

1. We can *refuel* at the next truck stop.
2. The crew *refueled* the plane in twenty minutes.
3. The ferry was *refueling* when we boarded.
...
To knock lightly against something.

1. Do not *bump* the car in front while parking.
...
To put something away neatly in a space made for it.

1. Please *stow* your bag under the seat.
...
To send a vehicle, person, or shipment out to a destination.

1. They *dispatch* trucks every two hours.
2. The office *dispatched* a tow truck within minutes.
3. Two vans have been *dispatched* to the warehouse.
...
To pay a company so that it will cover the cost if something is lost or damaged.

1. You can *insure* the package for its full value.
...
To move slowly along the ground, said of an airplane.

1. Planes *taxi* to the far end of the runway.
2. We *taxied* for twenty minutes before takeoff.
3. The jet was still *taxiing* when the crew stood up.
...
To share one car with other people for a regular trip.

1. Three of us *carpool* to the plant.
2. They *carpooled* all through college.
3. We have been *carpooling* since gas went up.
