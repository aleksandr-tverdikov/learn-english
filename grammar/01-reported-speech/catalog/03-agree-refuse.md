# Agreeing, refusing, promising, and threatening

> The verbs that report what a speaker committed to, went along with, or shut the door on.
...
Read the columns strictly. **+ to-inf** means the subject of the reporting verb is also the subject of the infinitive. **+ obj + to-inf** means a person comes between the verb and *to*. **+ that** covers any *that*-clause, indicative or subjunctive. **+ prep + -ing** means a gerund after an obligatory preposition, never a bare one. **+ NP** means a plain noun-phrase object taken with **no preposition** — whether it names the thing refused (*refused the offer*), the thing promised (*promised a refund*), or the person addressed (*assured her*, *warned him*). A noun reached through a preposition is not this column, which is why *opt **for** the smaller model* and *consent **to** the search* are marked ✗ with the preposition shown. A bare gerund used as a noun (*accepted losing the deposit*) does count as an NP here, not as **+ prep + -ing**.

| Verb | + to-inf | + obj + to-inf | + that | + prep + -ing | + NP |
|---|---|---|---|---|---|
| agree | ✓ | ✗ | ✓ | ✓ (*on doing*) | ✓ (*a price* — **BrE only**) |
| accept | ✗ | ✗ | ✓ | ✗ | ✓ (incl. bare *-ing*) |
| accede, assent | ✗ | ✗ | ✗ | ✓ (*to doing*) | ✗ (*to* + NP) |
| acquiesce | ✗ | ✗ | ✗ | ✓ (*in/to doing*) | ✗ (*in/to* + NP) |
| concur | ✗ | ✗ | ✓ | ✗ | ✗ |
| consent | ✓ | ✗ | ✗ | ✓ (*to doing*) | ✗ (*to* + NP) |
| offer, volunteer | ✓ | ✗ / ✓ (*volunteer* only) | ✗ / ✓ (*volunteer* only) | ✗ | ✓ |
| promise, guarantee, undertake, pledge, swear, vow | ✓ | ✗ | ✓ | ✗ | ✓ |
| assure | ✗ | ✗ | ✓ (**object required**) | ✗ | ✓ (*a person only*) |
| commit | ✗ | ✗ | ✗ | ✓ (*to doing*) | ✗ (*to* + NP) |
| refuse | ✓ | ✗ | ✗ | ✗ | ✓ (+ two objects) |
| decline | ✓ | ✗ | ✗ | ✗ | ✓ |
| demur | ✗ | ✗ | ✗ | ✓ (*at doing*) | ✗ (*at/to* + NP) |
| reject, turn down, veto, spurn, endorse, second | ✗ | ✗ | ✗ | ✗ | ✓ |
| threaten | ✓ | ✗ | ✓ | ✗ | ✓ |
| warn | ✗ | ✓ | ✓ (**object optional**) | ✓ (*against doing*) | ✓ |
| decide, resolve, determine | ✓ | ✗ | ✓ | ✓ (*on doing*) | ✓ |
| choose, opt, elect | ✓ | ✓ (*choose* only, = select) | ✗ | ✗ | ✓ (*choose*) / ✗ (*opt **for*** + NP) |
| arrange | ✓ | ✓ (**for** + obj) | ✓ | ✗ | ✓ |
| insist | ✗ | ✗ | ✓ | ✓ (*on doing*) | ✗ |

Three of these verbs — [arrange](#arrange), [insist](#insist), and [resolve](#resolve) — take the **mandative subjunctive** in the *that*-clause, so the verb inside appears in its bare form and never backshifts: *She insisted that he **be** there.* That construction is treated in full under [the mandative subjunctive](../06-commands-requests.md#the-mandative-subjunctive).
...
**Watch out:** the same verb also means *take office* (*acceded to the throne*) and *join a treaty* (*acceded to the convention*). All three senses share the *to*.  
**Reports:** formal agreement to a demand or request made by someone with a claim on you — where *agree* is neutral and *consent* grants permission, *accede* concedes ground.

> "Very well, we will release the files," the ministry said.  →  The ministry **acceded to the request**.

1. The board finally *acceded* to the union's demand for a wage review.
2. She *acceded* to his request that the letter be read aloud.
3. The city *acceded* to publishing the inspection reports online.
4. After three days of talks, the company *acceded*.
5. The government has never *acceded* to a single one of those conditions.
6. He *acceded* to the plan only because refusing would have cost him the contract.

**See also:** [agree](#agree), [assent](#assent), [consent](#consent), [acquiesce](#acquiesce), [concur](#concur)
...
> "Yes, I'll take the position," she said.  →  She **accepted the position**.
> "All right, I was wrong about the date," he said.  →  He **accepted that** he **had been** wrong about the date.

1. She *accepted* the offer without asking about the salary.
2. I *accept* that the numbers don't support my original estimate.
3. The committee *accepted* his resignation the same afternoon.
4. He never *accepted* the verdict as fair.
5. They *accepted* our apology and the matter ended there.
6. Nobody at the table *accepted* that the delay was anyone's fault.

**See also:** [agree](#agree), [consent](#consent), [decline](#decline), [refuse](#refuse), [reject](#reject), [turn down](#turn-down)
...
**in vs. to:** traditional and legal usage prefers *acquiesce **in***; *acquiesce **to*** is now at least as common in American writing and is not an error. *In* is the safer choice in formal prose.  
**Reports:** agreement given by not objecting — it reports compliance without endorsement, which no other verb in this group carries.

> "I don't like it, but fine," he said.  →  He **acquiesced in** the decision.

1. The minority shareholders *acquiesced* rather than fund another lawsuit.
2. She *acquiesced* in the reorganization but made her objections part of the record.
3. Congress *acquiesced* to the transfer of funds for two full budget cycles.
4. By saying nothing for six months, the landlord had *acquiesced* in the sublet.
5. He *acquiesced* to being interviewed only after his attorney approved the questions.
6. Nobody *acquiesces* to a rule they were never told about.

**See also:** [accede](#accede), [assent](#assent), [consent](#consent), [agree](#agree), [demur](#demur)
...
**Reports:** acceptance of a proposal or a statement — the plain, unmarked member of this group, with none of the reluctance of *acquiesce*, the formality of *assent*, or the permission-granting of *consent*.
...
> "I'll be there at four, then."  →  She **arranged to be** there at four.
> "Someone from the office will pick you up."  →  He **arranged for** someone **to pick** me up.

1. We *arranged* to meet in the lobby half an hour before the talk.
2. She *arranged* for the piano to be moved while we were out of town.
3. The clerk *arranged* that the deed be recorded the same day.
4. They still haven't *arranged* who is covering the front desk.
5. He *arranged* the whole trip in a single afternoon.
6. I've *arranged* for a neighbor to feed the cat.

**See also:** [agree](#agree), [promise](#promise), [undertake](#undertake), [decide](#decide), [offer](#offer)
...
**Homophone:** *assent* and *ascent* are pronounced identically. The verb of agreement is the one with two *s*'s in the middle; *ascent* is a climb and is only ever a noun.  
**Mostly a noun:** in ordinary American English the noun is far commoner than the verb: *she nodded her assent*, *royal assent*, *by common assent*. The verb belongs to formal narrative and legal prose.  
**Reports:** official or public agreement, usually to something formally put — where *agree* is a position, *assent* is an act performed on the record.

> "Agreed," said the chairman.  →  The chairman **assented**.

1. The trustees *assented* to the sale without discussion.
2. She *assented* with a single nod and said nothing more.
3. Both parties *assented* to having the hearing moved to Thursday.
4. He would not *assent* to any version of the text that named him.
5. The governor *assented* to the bill on the last day of the session.
6. Nobody in the room *assented*, and the motion died.

**See also:** [agree](#agree), [accede](#accede), [consent](#consent), [concur](#concur), [endorse](#endorse), [second](#second)
...
> "Don't worry, the check went out on Monday."  →  He **assured me that** the check **had gone** out on Monday.

1. The mechanic *assured* us that the noise was nothing serious.
2. She *assured* the family of her complete discretion.
3. I *assure* you, nobody outside this room has seen the draft.
4. He *assured* the board that the audit would be finished before the annual meeting.
5. They *assured* her of a full refund and then stopped answering her calls.
6. Let me *assure* you that we take every one of these reports seriously.

**See also:** [promise](#promise), [guarantee](#guarantee), [swear](#swear), [pledge](#pledge), [vow](#vow)
...
> "No, I'd rather not say anything."  →  He **chose not to** comment.

1. She *chose* to finish the degree part-time rather than take a year off.
2. The witness *chose* not to answer the last three questions.
3. They *chose* the smaller apartment because of the light.
4. The department *chose* her to lead the review.
5. He couldn't *choose* which of the two offers to take.
6. You may *choose* between a refund and a replacement.

**See also:** [opt](#opt), [elect](#elect), [decide](#decide), [decline](#decline), [refuse](#refuse)
...
> "Yes, I read the data the same way."  →  She **concurred that** the data **supported** the finding.

1. The second reviewer *concurred* that the methodology was sound.
2. Two of the three judges *concurred* in the judgment but wrote separately.
3. I *concur* with everything my colleague has just said.
4. The panel *concurred* on the diagnosis within an hour.
5. She read the report twice and *concurred*.
6. The auditors did not *concur* that the reserve was adequate.

**See also:** [agree](#agree), [assent](#assent), [accept](#accept), [endorse](#endorse), [second](#second)
...
> "Yes, you may search the car."  →  He **consented to** the search.
> "All right, I'll be recorded."  →  She **consented to be** recorded.

1. The patient *consented* to the procedure after reading the risks.
2. Her parents *consented* to her taking the internship abroad.
3. He *consented* to testify only under subpoena.
4. No landowner along the route has *consented*.
5. She *consented* to the sale of the property but not to the terms of the lease.
6. Both parties *consented* to having the dispute heard by an arbitrator.

**See also:** [agree](#agree), [accede](#accede), [assent](#assent), [acquiesce](#acquiesce), [refuse](#refuse)
...
> "We're going to take the northern route."  →  They **decided to take** the northern route.
> "The building is safe," the inspector said.  →  The inspector **decided that** the building **was** safe.

1. We *decided* to leave before the traffic started.
2. He *decided* that the whole thing had been a misunderstanding.
3. They still haven't *decided* where to hold the ceremony.
4. She *decided* against saying anything until she had the paperwork.
5. The panel *decided* the appeal in under a week.
6. I *decided* not to renew the lease.

**See also:** [resolve](#resolve), [determine](#determine), [choose](#choose), [opt](#opt), [elect](#elect), [arrange](#arrange)
...
> "Well… I'm not sure about that."  →  He **demurred**.

1. When I suggested splitting the cost, he *demurred*.
2. She *demurred* at the suggestion that the delay was her doing.
3. The committee *demurred* to the chair's reading of the bylaws.
4. "That seems a little steep," she *demurred*.
5. He *demurred* at paying in advance and asked for an invoice instead.
6. Nobody *demurred*, so the motion carried.

**See also:** [decline](#decline), [refuse](#refuse), [acquiesce](#acquiesce), [assent](#assent), [reject](#reject)
...
> "I am going to see this through, whatever it costs."  →  She **determined to see** it through.
> "The valve failed before the fire started," the investigators said.  →  Investigators **determined that** the valve **had failed** before the fire started.

1. He *determined* to learn the language before the posting began.
2. The inspector *determined* that the wiring had never been permitted.
3. We could not *determine* who had signed the form.
4. The court will *determine* the amount of damages next month.
5. She had *determined* on a complete change of career.
6. They were *determined* to have the roof finished before the rain.

**See also:** [decide](#decide), [resolve](#resolve), [choose](#choose), [vow](#vow), [pledge](#pledge)
...
> "I'll take the lump sum rather than the annuity."  →  She **elected to take** the lump sum.

1. Employees who *elect* to enroll must do so before the fifteenth.
2. He *elected* not to appeal the ruling.
3. She *elected* to have the surgery in January rather than wait.
4. Most of the partners *elected* to defer their distributions.
5. The taxpayer may *elect* to spread the gain over four years.
6. Two of the three defendants *elected* to testify.

**See also:** [opt](#opt), [choose](#choose), [decide](#decide), [decline](#decline), [determine](#determine)
...
> "We're backing Alvarez," the union said.  →  The union **endorsed Alvarez**.

1. Three former governors *endorsed* the ballot measure.
2. The academy has never *endorsed* a commercial product.
3. She *endorsed* the report's conclusions but not its tone.
4. He refused to *endorse* anyone in the primary.
5. The paper *endorsed* the bond issue in an editorial on Sunday.
6. Two of the co-authors declined to *endorse* the final draft.

**See also:** [agree](#agree), [second](#second), [concur](#concur), [assent](#assent), [reject](#reject)
...
> "I did lock it. I know I did."  →  He **insisted that** he **had locked** it.

1. The doctor *insisted* that he stay off the ankle for two weeks.
2. She *insisted* that the check had been mailed on the first.
3. He *insisted* on paying for dinner and would not hear another word about it.
4. They *insisted* on seeing the original document, not a copy.
5. I offered to walk, but she *insisted*.
6. The airline *insists* that every passenger be at the gate forty minutes early.

**See also:** [refuse](#refuse), [agree](#agree), [swear](#swear), [vow](#vow), [threaten](#threaten)
...
> "I'll take the train instead."  →  She **opted to take** the train.

1. Most families *opted* for the later session.
2. He *opted* to walk rather than wait forty minutes for a bus.
3. You can *opt* out of the mailing list at any time.
4. The school *opted* to close for the day.
5. She *opted* in to the pilot program on the first morning.
6. Faced with two bad choices, they *opted* for the cheaper one.

**See also:** [choose](#choose), [elect](#elect), [decide](#decide), [decline](#decline), [resolve](#resolve)
...
> "We will rebuild every school damaged in the storm," the governor said.  →  The governor **pledged to rebuild** every school damaged in the storm.

1. The foundation *pledged* two million dollars over four years.
2. She *pledged* to serve only one term.
3. The company *pledged* that no jobs would be moved overseas.
4. Donors *pledged* more than the campaign had asked for.
5. He *pledged* himself to silence about what he had seen.
6. Both candidates *pledged* to release their tax returns.

**See also:** [promise](#promise), [vow](#vow), [swear](#swear), [commit](#commit), [undertake](#undertake), [guarantee](#guarantee)
...
**Reports:** a commitment by the speaker to do something, staking their reliability on it — where *offer* proposes and *agree* accepts, *promise* binds.

> "I'll have it done by Friday," she said.  →  She **promised to have** it done by Friday.
> "I swear I'll be there, Mom."  →  He **promised his mother that** he **would be** there.

1. He *promised* to call as soon as the plane landed.
2. She *promised* me that nobody else would see the file.
3. The contractor *promised* a finished kitchen by Thanksgiving.
4. I *promise* I won't say a word.
5. They *promised* the neighbors a full report and never delivered one.
6. Don't *promise* anything you can't put in writing.

**See also:** [pledge](#pledge), [vow](#vow), [swear](#swear), [guarantee](#guarantee), [assure](#assure), [undertake](#undertake), [commit](#commit), [threaten](#threaten)
...
> "No, I'm not signing that," she said.  →  She **refused to sign** it.
> "I won't answer any more questions."  →  He **refused to answer** any more questions.

1. He *refused* to give his name to the officer.
2. The bank *refused* her application without explaining why.
3. She *refused* the promotion twice before finally taking it.
4. They *refused* us entry because the doors had already closed.
5. The engine *refused* to start in the cold.
6. I asked three times and he *refused* every time.

**See also:** [decline](#decline), [reject](#reject), [turn down](#turn-down), [spurn](#spurn), [veto](#veto), [agree](#agree), [consent](#consent)
...
> "I support that motion."  →  She **seconded the motion**.

1. Ramirez moved to adjourn and Chen *seconded*.
2. The nomination was *seconded* before the chair had finished speaking.
3. "I'll *second* that," he said, reaching for his coffee.
4. No one *seconded* the motion, so it was not debated.
5. She *seconded* the proposal but voted against it an hour later.
6. Every motion has to be *seconded* to reach the floor.

**See also:** [endorse](#endorse), [agree](#agree), [concur](#concur), [assent](#assent), [veto](#veto)
...
> "Keep your money. I want nothing from you."  →  She **spurned the offer**.

1. He *spurned* every attempt his family made to reach him.
2. The novelist *spurned* the prize and said so in a letter to the committee.
3. She *spurned* his apology and walked out.
4. Voters *spurned* the incumbent for the first time in thirty years.
5. The club *spurned* an offer twice what the player was worth.
6. Having been *spurned* once, he did not ask again.

**See also:** [reject](#reject), [refuse](#refuse), [decline](#decline), [turn down](#turn-down), [veto](#veto)
...
**Reports:** a promise or an assertion made under an oath, real or rhetorical — it reports the speaker invoking a penalty for being wrong, which *promise* and *say* do not.

> "I will pay back every cent, I swear."  →  He **swore to pay back** every cent.
> "I did lock the door — I swear I did."  →  She **swore that** she **had locked** the door.

1. The witness *swore* that she had never met the defendant.
2. He *swore* to tell the whole story once the case was closed.
3. She *swore* us all to secrecy before opening the envelope.
4. I *swear* I put the keys on the hook.
5. Every officer *swears* an oath before taking the badge.
6. He *swore* he would never set foot in that building again.

**See also:** [vow](#vow), [pledge](#pledge), [promise](#promise), [guarantee](#guarantee), [assure](#assure), [insist](#insist)
...
**Reports:** a commitment to do something the listener does not want, made in order to change their behavior — the negative counterpart of *promise*, and unlike *warn* it names the speaker as the source of the harm.
...
> "Thanks, but I'm going to stay where I am."  →  She **turned down** the job.
> "No thanks, not for me."  →  He **turned it down**.

1. She *turned down* a full scholarship to stay near her mother.
2. They offered him twice the salary and he *turned* it *down*.
3. The zoning board *turned down* the application for the third time.
4. I'd *turn down* anything that meant moving in January.
5. He was *turned down* by four banks before one said yes.
6. You don't *turn down* an invitation like that without a reason.

**See also:** [reject](#reject), [decline](#decline), [refuse](#refuse), [spurn](#spurn), [accept](#accept), [offer](#offer)
...
> "We will keep the records for seven years."  →  The firm **undertook to keep** the records for seven years.

1. The tenant *undertakes* to return the property in the condition received.
2. She *undertook* to deliver the manuscript by the end of the year.
3. The company *undertook* that no personal data would leave the country.
4. He *undertook* the negotiation himself rather than send a deputy.
5. Neither party has *undertaken* to cover the other's costs.
6. They *undertook* a complete review of the safety procedures.

**See also:** [promise](#promise), [pledge](#pledge), [guarantee](#guarantee), [commit](#commit), [agree](#agree), [arrange](#arrange)
...
> "No. That isn't going forward."  →  The governor **vetoed the bill**.

1. The president *vetoed* the spending bill on the last day of the session.
2. Two members of the council *vetoed* the whole redevelopment plan.
3. She *vetoed* the idea of a surprise party before anyone could argue.
4. The measure was *vetoed* and never came back to the floor.
5. Any permanent member may *veto* a resolution.
6. He *vetoed* three of the four names on the shortlist.

**See also:** [reject](#reject), [refuse](#refuse), [turn down](#turn-down), [decline](#decline), [second](#second), [endorse](#endorse)
...
> "I'll stay and lock up."  →  She **volunteered to stay** and lock up.
> Nobody asked, and he said: "I was at the house that night."  →  He **volunteered that** he **had been** at the house that night.

1. Two students *volunteered* to help set up the chairs.
2. He *volunteered* that he had never actually read the contract.
3. My brother *volunteered* me to drive everyone to the airport.
4. She *volunteered* the name of the supplier before anyone asked for it.
5. Nobody *volunteered*, so the chair assigned the task.
6. They *volunteered* for the night shift because it paid more.

**See also:** [offer](#offer), [agree](#agree), [promise](#promise), [undertake](#undertake), [decline](#decline)
...
> "I will never work for that company again."  →  He **vowed never to work** for the company again.
> "We'll be back, and next time we'll win."  →  She **vowed that** they **would be** back.

1. The mayor *vowed* to appeal the ruling within the week.
2. She *vowed* that she would never lend him money again.
3. He *vowed* revenge on everyone who had testified.
4. They *vowed* to rebuild on the same lot.
5. After the second flood, she *vowed* to sell the house.
6. The candidate *vowed* to serve out the full term.

**See also:** [swear](#swear), [pledge](#pledge), [promise](#promise), [resolve](#resolve), [threaten](#threaten), [determine](#determine)
...
> "Don't touch those wires."  →  The electrician **warned us not to touch** those wires.

1. The landlord *warned* them that the next late payment would start eviction.
2. She *warned* me not to sign anything before the lawyer had read it.
3. Regulators *warned* that the bank was undercapitalized.
4. He *warned* us about the ice on the bottom step.
5. Her attorney *warned* her against speaking to reporters.
6. I *warned* him twice, and after that I stopped.

**See also:** [threaten](#threaten), [promise](#promise), [insist](#insist), [swear](#swear), [advise](05-advise-suggest.md#advise)
...
- [Reported commands, requests, and advice](../06-commands-requests.md) — the to-infinitive route in full, including [offers, promises, refusals, and threats](../06-commands-requests.md#offers-promises-refusals-and-threats) and [the mandative subjunctive](../06-commands-requests.md#the-mandative-subjunctive)
- [Backshift](../02-backshift.md) — why *will* disappears into *promised to* and *won't* into *refused to*
- [When not to backshift](../03-no-backshift.md) — live promises, standing refusals, and the subjunctive that cannot move
- [Modal verbs in reported speech](../07-modals.md) — the modals these verbs absorb
- [Special cases](../08-special-cases.md#reporting-conditionals) — how a conditional threat or promise collapses into a single verb
- [Verbs](../../../parts-of-speech/03-verbs/README.md) — complementation, tense, and mood as a word class
